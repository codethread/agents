...
```json
{
	...
	"prompts": {
		"baseline": {
			"path": "/home/codethread/.pi/agent/bench-sessions/2026-04-13T14-30-00/plugins/baseline.md"
		},
		"strict": {
			"path": "/home/codethread/.pi/agent/bench-sessions/2026-04-13T14-30-00/plugins/strict.md"
		}
	},
	"lastRun": null,
	"entries": {
...
```json
{
	...
	"prompts": { "<slug>": { "path": "<session-dir/plugins/slug.md>" } },
	"lastRun": "<run-id>"
}
```
...
Write all active prompt variants into the new run's `plugins/` directory. Each run is self-contained. Old runs keep their historical files.
