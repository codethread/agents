...
| Spec                                                                     | Purpose                                                                                                                                 | Code                                                            |
| ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| [subagent--discovery-and-config.md](./subagent--discovery-and-config.md) | Defines how bundled, user, and project agents plus planned swarms are discovered, normalized, and handed to subagent runtime execution. | `pi-extensions/tools/subagent/`, `pi-agents/*.md`               |
| [subagent--orchestration.md](./subagent--orchestration.md)               | Defines subagent runtime execution: single-agent runs, planned swarm fan-out, persisted resume, streaming updates, and UI rendering.    | `pi-extensions/tools/subagent/`, `pi-extensions/ui/statusline/` |
