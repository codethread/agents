...
| [subagent--dynamic-model-selection.md](./subagent--dynamic-model-selection.md) | Defines planned dynamic subagent model chains, environment-gated candidates, validation, retry/advance behavior, and metadata boundaries. | `pi-extensions/tools/subagent/`, `pi-agents/*.md`               |
