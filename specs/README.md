...
| [questionnaire-interaction.md](./questionnaire-interaction.md)       | Defines the questionnaire tool as an external-editor-backed markdown form, including question normalization, response parsing, and structured result reporting. | `pi-extensions/extensions/questionnaire.ts`, `pi-extensions/extensions/README.md`                                                                                                                                               |
